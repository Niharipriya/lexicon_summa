...
# About TAB
about_label1 = Label(tab5,text="Lexicon summa",pady=5,padx=5)
about_label2 = Label(tab5,text="Team Members",pady=5,padx=5)
about_label3 = Label(tab5,text="Nihari Priya (E20CSE414)",pady=5,padx=5)
about_label4 = Label(tab5,text="Vijaya Lakshmi (E20CSE332)",pady=5,padx=5)
